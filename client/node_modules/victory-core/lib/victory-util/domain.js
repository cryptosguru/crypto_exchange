...
function getDomainWithZero(props, axis) {
  ...
  var ensureZero = function (domain) {
    ...
    var min = minDomain !== undefined ? minDomain : _collection.default.getMinValue(domain, defaultMin);
    var max = maxDomain !== undefined ? maxDomain : _collection.default.getMaxValue(domain, defaultMax);
