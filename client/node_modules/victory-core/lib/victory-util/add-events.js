    ...
    function (_WrappedComponent) {
      ...
      _createClass(addEvents, [{
        ...
        value: function componentDidUpdate() {
          ...
          if (!(0, _reactFastCompare.default)(this.externalMutations, externalMutations)) {
        ...
        value: function getStateChanges(props, calculatedValues) {
          ...
          var getState = function (key, type) {
            var baseState = (0, _defaults2.default)({}, _this2.getEventState(key, type), getSharedEventState(key, type));
            return (0, _isEmpty2.default)(baseState) ? undefined : baseState;
          };
