...
function getDomainWithZero(props, axis) {
  ...
  var ensureZero = function (domain) {
    ...
    var min = minDomain !== undefined ? minDomain : Collection.getMinValue(domain, defaultMin);
    var max = maxDomain !== undefined ? maxDomain : Collection.getMaxValue(domain, defaultMax);
